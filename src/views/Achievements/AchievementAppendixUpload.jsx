...
class AchievementAppendixUpload extends React.Component {
  constructor(...props) {
    super(...props)
  ...
  beforeUpload = (file, fileList) => {
    ...
    else if (file.size / 1024 / 1024 >= this.props.maxSize) {
      message.warning(`图片大小超出限制（应小于${this.props.maxSize}M），请修改后重新上传`)
      return false
    }
    return true
  }
...
export default AchievementAppendixUpload